...
from link import *
from api.sql import Analysis,MFGAnalysis

analysis = Blueprint('analysis', __name__, template_folder='../templates')


@analysis.route('/MFGdashboard')
@login_required
def MFGdashboard():
    revenue = []
    dataa = []
    for i in range(1,13):
        row = MFGAnalysis.month_price(i)
    ...
    row = MFGAnalysis.member_sale_count()
    countList = []
